        ...
        if (theEntity.isHandActive())
        {
            ...
            if (itemstack == theEntity.getActiveItemStack())
            {
                if (!theEntity.getActiveItemStack().isEmpty())
                {
                    ...
                    try
                    {
                        activeItemStackUseCount.setInt(theEntity, net.minecraftforge.event.ForgeEventFactory.onItemUseTick(theEntity,
                ...
                try
                {
                    if (activeItemStackUseCount.getInt(theEntity) - 1 <= 0 && !theEntity.world.isRemote)
                    {
                        ...
                        if (!theEntity.getActiveItemStack().isEmpty() && theEntity.isHandActive())
                        {
                            ...
                            itemstack2 = net.minecraftforge.event.ForgeEventFactory.onItemUseFinish(theEntity, theEntity.getActiveItemStack(),
            ...
            for (EntityEquipmentSlot entityequipmentslot : EntityEquipmentSlot.values())
            {
                ...
                if (!ItemStack.areItemStacksEqual(itemstack, itemstack1))
                {
                    ...
                    net.minecraftforge.common.MinecraftForge.EVENT_BUS
                            .post(new net.minecraftforge.event.entity.living.LivingEquipmentChangeEvent(theEntity, entityequipmentslot, itemstack, itemstack1));
