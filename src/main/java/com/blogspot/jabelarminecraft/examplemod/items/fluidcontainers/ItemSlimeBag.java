...
public class ItemSlimeBag extends Item
{
                        ...
                        else // fluid can be placed in world
                        {
                            ...
                            else // location is placeable
                            {
                                ...
                                else // fluid does not vaporize
                                {
                                    ...
                                    {
                                        // DEBUG
                                        System.out.println("Before transferring fluids amount in container = " + amountInContainer + " and block capacity = "
                                                + blockCapacity);
                                        ...
                                        // DEBUG
                                        System.out.println("After transferring amount in container = " + containerFluidStack.amount + " and amount in block = "
                                                + blockFluidStack.amount);
                                        ...
                                        if (!parPlayer.capabilities.isCreativeMode)
                                        {
                                            ...
                                            // DEBUG
                                            System.out.println("After transfer block fluid stack = " + blockFluidStack.getFluid() + " " + blockFluidStack.amount
                                                    + " and container fluid stack now = " + containerFluidStack.getFluid() + " " + containerFluidStack.amount);
     ...
     * @param mop
     *            the mop
     * @param parContainerStack
     *            the par container stack
     * @return the action result
     */
                        ...
                        else // room in container
                        {
                            ...
                            if (sourceFluidStack != null)
                            {
                                ...
                                else // some fluid in source
                                {
                                    ...
                                    System.out.println("Before transfer source fluid stack = " + sourceFluidStack.getFluid() + " " + sourceFluidStack.amount
                                            + " and container fluid stack now = " + containerFluidStack.getFluid() + " " + containerFluidStack.amount);
                                    ...
                                    // DEBUG
                                    System.out.println("After transfer source fluid stack = " + sourceFluidStack.getFluid() + " " + sourceFluidStack.amount
                                            + " and container fluid stack now = " + containerFluidStack.getFluid() + " " + containerFluidStack.amount);
