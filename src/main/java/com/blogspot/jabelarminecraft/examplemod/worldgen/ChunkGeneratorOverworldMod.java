...
public class ChunkGeneratorOverworldMod implements IChunkGenerator
{
    ...
    public ChunkGeneratorOverworldMod(World worldIn, long seed, boolean mapFeaturesEnabledIn, String generatorOptions)
    {
        {
    ...
    public Chunk generateChunk(int x, int z)
    {
        ...
        System.out.println("Generated Chunk " + x + " " + z);
        System.out.println("Setting Blocks took " + (setBlocks - begin));
        System.out.println("Replacing Biome Blocks took " + (setBiome - setBlocks));
        System.out.println("Generating Structures took " + (genStructures - setBiome));
        System.out.println("Generating Lightmap and getting Biomes for gen took " + (genLight - genStructures));
        System.out.println("Generation took " + (genLight - begin));
        // Log.logString(" ");
